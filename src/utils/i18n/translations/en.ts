...
export const en: TranslationType = {
  ...
  etfsDescription: "Diversified investment funds",
  forexDescription: "Currency trading pairs",
  indicesDescription: "Major market indices",
  aiEtfsDescription: "AI-focused investment funds"
};