...
export const fr: TranslationType = {
  ...
  sixMonths: "6 Mois",
  year: "1 An",
  shortTermForecast: "Sur la base des indicateurs de marché à court terme, nous prévoyons une {direction} de {percentage}% la semaine prochaine.",
  monthlyForecast: "Notre projection mensuelle suggère une {direction} de {percentage}%.",
  sixMonthForecast: "Sur un horizon de 6 mois, notre analyse indique une {direction} de {percentage}%.",
  yearlyForecast: "Notre prévision annuelle montre une {direction} de {percentage}%.",
