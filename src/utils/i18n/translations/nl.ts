...
export const nl: TranslationType = {
  ...
  monthlyForecast: "Onze maandprognose houdt rekening met bredere markttrends, aankomende sectorgebeurtenissen en technische analyse, wat wijst op een {direction} van {percentage}%. Dit houdt rekening met mogelijke marktaanpassingen en sectordynamiek.",
  ...
  aiEtfsDescription: "ETFs gericht op kunstmatige intelligentie"
};