...
export const pt: TranslationType = {
  ...
  sixMonths: "6 Meses",
  year: "1 Ano",
  shortTermForecast: "Com base nos indicadores de mercado de curto prazo e padrões de negociação recentes, esperamos um {direction} de {percentage}% na próxima semana. Esta previsão considera o sentimento atual do mercado e fatores técnicos imediatos.",
  ...
  aiEtfsDescription: "ETFs focados em IA"
};